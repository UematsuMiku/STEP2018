...
public class Longest_search {
    ...
    public static void main(String[] args) {
        ...
        int binary_leng = (int) Math.pow(2, leng);   //入力された文字からできるパターン数,3文字なら2^3=8
        ...
        int count = 0;
        String key;
        for(int i =0;count<5 && i<binary_leng;i++) {
            ...
            int id = Collections.binarySearch(list2, key);  //文字列が作り変えた辞書内にあるか探索
                if(id > 0) {
                    ...
                    if (Integer.parseInt(kouho_score[i][1]) > 100) {
                        count++;
                        System.out.println(target + " " + kouho_score[i][1]);               //120点以上を５つ出力
                    }
                }
